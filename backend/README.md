...
## Project Structure
    ...
    ├── ideapros_llc_move_32953  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_move_32953`
...
2. Clone this repo and `cd ideapros_llc_move_32953`
